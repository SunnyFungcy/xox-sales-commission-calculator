...
const zhTW = {
  ...
  rebateEqIntro:
    "階差返傭以手續費 feeUsd 為基數（不先扣 EdgeX）。下行「平台淨」僅供報表。以下為前 3 筆。",
  rebateEqNetShort: "平台淨",
...
const en: Record<MessageKey, string> = {
  ...
  rebateEqIntro:
    "Tier-delta rebates use feeUsd (EdgeX not deducted first). “Platform net” below is for reporting only. Showing first 3 trades.",
  rebateEqNetShort: "Platform net",
